...
export const OneHundredLayout: KeyboardLayout = {
  functionKeys: [
  ...
  numberPad: [
    ...
    [
      { size: KeyCapSize.ONE_U, orientation: KeyCapOrientation.HORIZONTAL, topLabel: 'NmLk' },
      { size: KeyCapSize.ONE_U, orientation: KeyCapOrientation.HORIZONTAL, topLabel: '/' },
      { size: KeyCapSize.ONE_U, orientation: KeyCapOrientation.HORIZONTAL, topLabel: '*' },
    ],
    [
      { size: KeyCapSize.ONE_U, orientation: KeyCapOrientation.HORIZONTAL, topLabel: '7', bottomLabel: 'Home' },
      { size: KeyCapSize.ONE_U, orientation: KeyCapOrientation.HORIZONTAL, topLabel: '8', bottomLabel: '↑' },
      { size: KeyCapSize.ONE_U, orientation: KeyCapOrientation.HORIZONTAL, topLabel: '9', bottomLabel: 'PgUp' },
    ],
    [
      { size: KeyCapSize.ONE_U, orientation: KeyCapOrientation.HORIZONTAL, topLabel: '4', bottomLabel: '←' },
      { size: KeyCapSize.ONE_U, orientation: KeyCapOrientation.HORIZONTAL, topLabel: '5' },
      { size: KeyCapSize.ONE_U, orientation: KeyCapOrientation.HORIZONTAL, topLabel: '6', bottomLabel: '→' },
    ],
    [
      { size: KeyCapSize.ONE_U, orientation: KeyCapOrientation.HORIZONTAL, topLabel: '1', bottomLabel: 'End' },
      { size: KeyCapSize.ONE_U, orientation: KeyCapOrientation.HORIZONTAL, topLabel: '2', bottomLabel: '↓' },
      { size: KeyCapSize.ONE_U, orientation: KeyCapOrientation.HORIZONTAL, topLabel: '3', bottomLabel: 'PgDn' },
    ],
    [
      { size: KeyCapSize.TWO_U, orientation: KeyCapOrientation.HORIZONTAL, topLabel: '0', bottomLabel: 'Ins' },
      { size: KeyCapSize.ONE_U, orientation: KeyCapOrientation.HORIZONTAL, topLabel: '.', bottomLabel: 'Del' },
    ]
  ],
  numberPadEndColumn: [
    { width: KEY_CAP_SIZE, height: KEY_CAP_SIZE },
    { width: KEY_CAP_SIZE, height: (KEY_CAP_SIZE / 2.0) - 5 },
    { size: KeyCapSize.ONE_U, orientation: KeyCapOrientation.VERTICAL, topLabel: '-' },
    { size: KeyCapSize.TWO_U, orientation: KeyCapOrientation.VERTICAL, topLabel: '+' },
    { size: KeyCapSize.TWO_U, orientation: KeyCapOrientation.VERTICAL, topLabel: 'Enter' },
  ],
  typingKeys: [
    [
      { width: KEY_CAP_SIZE, height: (KEY_CAP_SIZE / 2.0) - 5 }
