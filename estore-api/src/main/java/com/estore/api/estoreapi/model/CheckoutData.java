...
public class CheckoutData {
   ...
   */
  public CheckoutData(@JsonProperty("userID") int userID, @JsonProperty("ccNumber") String creditCardNumber, @JsonProperty("ccExpiration") String creditCardExpiration, 
  ...
  public String toString() {
    return String.format(STRING_FORMAT, this.userID, this.creditCardNumber, this.creditCardExpiration, this.creditCardCVC, this.creditCardHolder, this.creditCardZipCode);
  } 
}
