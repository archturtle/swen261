...
public class KeyboardController {
   ...
   *
   * @param keyboardDao The {@link KeyboardDAO Keyboard Data Access Object} to perform CRUD operations
   * <br>
  ...
  /**
   * Responds to the GET request for a {@linkplain Keyboard keyboard} for the given id
   *
   * @param id The id used to locate the {@link Keyboard keyboard}
   *
   * @return ResponseEntity with {@link Keyboard keyboard} object and HTTP status of OK if found<br>
   ...
   *
   * @return ResponseEntity with array of {@link Keyboard keyboard} objects (may be empty) and
  ...
  /**
   * Responds to the GET request for all {@linkplain Keyboard keyboards} whose name contains
   * the text in name
   *
   * @param name The name parameter which contains the text used to find the {@link Keyboard keyboards}
   *
   * @return ResponseEntity with array of {@link Keyboards keyboard} objects (may be empty) and
   * HTTP status of OK<br>
   * ResponseEntity with HTTP status of INTERNAL_SERVER_ERROR otherwise
   * <p>
   ...
   *
   * @return ResponseEntity with created {@link Keyboard keyboard} object and HTTP status of CREATED<br>
   * ResponseEntity with HTTP status of CONFLICT if {@link Keyboard keyboard} object already exists<br>
   * ResponseEntity with HTTP status of INTERNAL_SERVER_ERROR otherwise
   */
  @PostMapping("")
  public ResponseEntity<Keyboard> createKeyboard(@RequestBody Keyboard keyboard) {
      ...
      try {
          ...
          if (found.length != 0) return new ResponseEntity<>(HttpStatus.CONFLICT);
  ...
  /**
   * Updates the {@linkplain Keyboard keyboard} with the provided {@linkplain Keyboard keyboard} object, if it exists
   *
   * @param keyboard The {@link Keyboard keyboard} to update
   *
   * @return ResponseEntity with updated {@link Keyboard keyboard} object and HTTP status of OK if updated<br>
   * ResponseEntity with HTTP status of NOT_FOUND if not found<br>
   * ResponseEntity with HTTP status of INTERNAL_SERVER_ERROR otherwise
   */
  @PutMapping("")
